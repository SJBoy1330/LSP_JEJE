	                        ...
	                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
	                            <thead>
	                                <tr class="fw-bolder text-muted">
	                                    ...
	                                    <th class="min-w-140px">Menu Makanan</th>
	                                ...
	                                <tr>
	                                    ...
	                                    <td>
	                                        <div class="d-flex align-items-center">
	                                            <span href="#" class="text-dark fw-bolder fs-6">Sidatata Al Jennar</span>
	                                        </div>
	                                    </td>
	                                    <td class="d-flex">
	                                        ...
	                                        <div class="d-flex align-self-center justify-content-start flex-column">
	                                            <span href="#" class="text-dark fw-bolder fs-6">Mie Goreng</span>
	                                        </div>
	                                    </td>
	                                    <td class="text-end">
	                                        <div class="d-flex align-items-center">
	                                            <span href="#" class="text-dark fw-bolder fs-6">Rp. 150.000</span>
	                                        </div>
	                                    </td>
	                                    <td>
